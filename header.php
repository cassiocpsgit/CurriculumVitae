				...
				<div class="header-column">
					<div class="header-row">
						<div class="header-logo">
							<a href="index.html"><img alt="Foto Cassio" width="70" height="70" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="img/foto_oculos_redonda.png"></a>
						</div>
					</div>
				</div>
							...
							<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
								<nav class="collapse">
									<ul class="nav nav-pills" id="mainNav">
										...
										<li class="dropdown">
											<a class="dropdown-item dropdown-toggle" href="indexjs.html">
												Projetos
											</a>
											<ul class="dropdown-menu">
												<li>
													<a class="dropdown-item" href="indexjs.html">
														<p>JavaScript</p>
													</a>
												</li>
											</ul>
										...
										<li class="dropdown">
											<a class="dropdown-item dropdown-toggle" href="https://cassiocpsgit.github.io/html_css/">
												Cursos
											</a>
										</li>
										<li class="dropdown">
											...
											<ul class="dropdown-menu">
												<li>
													<a class="dropdown-item" href="index.html">
														<p>Endereço</p>
														<p>Rua Darzan, 68, Santana, São Paulo - SP - Brasil</p>
													</a>
												</li>
												<li>
													<a class="dropdown-item" href="index.html#demos">
														<p>PHONE</p>
														<p>+55-12-99679-9346</p>
													</a>
												</li>
												<li>
													<a class="dropdown-item" href="index.html#demos">
														<p>EMAIL</p>
														<a href="mailto:mail@example.com">cassiocortezps@gmail.com</a>
													</a>
												</li>
											</ul>
										</li>
